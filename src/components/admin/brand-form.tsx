        ...
        <div className="mt-2 flex min-h-24 items-center justify-center gap-6 border border-sand-dark bg-sand p-6">
          {logoUrl ? (
            isFavicon ? (
              ...
              <>
                <span className="flex items-center gap-2 border border-sand-dark bg-black px-3 py-2">
      ...
      <form action={formAction} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            required
            className="w-full border border-sand-dark bg-black px-4 py-2.5 text-sm file:mr-4 file:border-0 file:bg-ink file:px-4 file:py-2 file:font-display file:text-xs file:font-bold file:uppercase file:tracking-widest file:text-black"
          />
