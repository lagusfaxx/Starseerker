      ...
      <section className="border border-sand-dark bg-black">
        ...
        <div className="border-t border-sand-dark p-4">
          <button
            ...
            className="btn border-2 border-ink px-5 py-2.5 text-ink transition-colors hover:bg-ink hover:text-black disabled:cursor-not-allowed disabled:opacity-40"
          >
            Agregar producto
          </button>
        </div>
