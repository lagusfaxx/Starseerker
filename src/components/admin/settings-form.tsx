    ...
    <form action={formAction} className="space-y-5">
      ...
      <div>
        ...
        <input
          ...
          maxLength={70}
          className="field"
          placeholder="STARSEEKER Chile | Molinos y maquinas de espresso portatiles"
        />
        <p className="mt-1.5 text-xs text-ink-muted">
      ...
      <div>
        ...
        <input
          ...
          maxLength={120}
          className="field"
          placeholder="STARSEEKER Chile: molinos electricos y maquinas de espresso portatiles"
        />
        <p className="mt-1.5 text-xs text-ink-muted">
