        ...
        {data.map((point) => {
          ...
          return (
            ...
            <div key={point.date} className="group relative flex h-full flex-1 flex-col justify-end">
              ...
              />
              <span className="pointer-events-none absolute bottom-full left-1/2 z-10 mb-2 hidden -translate-x-1/2 whitespace-nowrap rounded bg-ink px-2.5 py-1.5 text-xs text-black group-hover:block">
                {label}
              </span>
            </div>
          );
