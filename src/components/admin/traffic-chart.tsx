          ...
          return (
            ...
            <div key={point.date} className="group relative flex h-full flex-1 flex-col justify-end">
              <span
                ...
                style={{ height: `${alto}%` }}
              />
              <span className="pointer-events-none absolute bottom-full left-1/2 z-10 mb-2 hidden -translate-x-1/2 whitespace-nowrap bg-ink px-2 py-1 text-xs text-black group-hover:block">
                {etiqueta}
              </span>
            </div>
          );
