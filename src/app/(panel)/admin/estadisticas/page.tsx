...
export default async function AdminStatsPage({ searchParams }: PageProps) {
  ...
  return (
    <>
      ...
      {/* --- Ahora mismo ------------------------------------------------- */}
      <section className="mt-8 border border-sand-dark bg-ink text-black">
        <div className="grid gap-px bg-black/40 sm:grid-cols-3">
          <LiveTile
        ...
        {live.watching.length > 0 ? (
          <div className="border-t border-white/10 p-6">
            <h2 className="font-display text-xs font-bold uppercase tracking-[0.28em] text-ink-muted">
              Que estan mirando
            </h2>
          ...
          <p className="border-t border-white/10 p-6 text-sm text-ink-muted">
      ...
      <section className="mt-4 border border-sand-dark bg-black p-6">
      ...
      <section className="mt-10">
        ...
        {abandoned.length === 0 ? (
          <p className="mt-6 border border-dashed border-sand-dark bg-black px-6 py-14 text-center text-sm text-ink-muted">
          ...
          <ul className="mt-6 space-y-3">
            {abandoned.map((cart) => {
              ...
              return (
                <li
                  key={cart.id}
                  className="flex flex-wrap items-start justify-between gap-4 border border-sand-dark bg-black px-6 py-5"
                >
