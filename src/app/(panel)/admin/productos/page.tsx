...
export default async function AdminProductsPage({ searchParams }: PageProps) {
  ...
  return (
    <>
      ...
      <div className="mt-6 border border-sand-dark bg-black">
        {products.length === 0 ? (
                    ...
                    <td>
                      <form action={updateStock} className="flex items-center gap-1.5">
                        ...
                        <input
                          ...
                          min={0}
                          max={1000000}
                          className="w-20 border border-sand-dark bg-sand px-2 py-1 text-sm tabular-nums text-ink focus:border-ink focus:outline-none"
