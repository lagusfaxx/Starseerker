...
export const metadata: Metadata = {
  ...
  description: 'Catalogo completo STARSEEKER Chile: molinos electricos, maquinas de espresso portatiles y accesorios.',
};
      ...
      <header className="border-b border-sand-dark bg-sand">
        <div className="container-site py-14">
          ...
          <p className="mt-4 max-w-xl text-base text-ink-muted">
            Molinos electricos, maquinas de espresso portatiles y los accesorios que
    ...
    <Link
      ...
      className={`border px-4 py-2 font-display text-xs font-semibold uppercase tracking-widest transition-colors ${
        active
          ...
          : 'border-sand-dark bg-black text-ink-soft hover:border-ink hover:text-ink'
      }`}
    >
      {children}
    </Link>
